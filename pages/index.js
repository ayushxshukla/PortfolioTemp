        ...
        <section className=" min-h-screen">
          <nav className=" py-10 mb-12 flex justify-between dark:text-white">
            ...
            <ul className=' flex items-center'>
              ...
              <li><a href="https://drive.google.com/file/d/1aJbkM1icmdg5l31LgWA_9Il8_qmLybBC/view?usp=sharing" className=' bg-gradient-to-r from-cyan-500 to-teal-500 text-white px-4 py-2 rounded-md ml-8' >Resume</a></li>
            </ul>
          </nav>
          <div className='text-center p-10 '>
            <h2 className=' text-5xl py2 text-teal-600 dark:text-teal-400 font-medium md:text-6xl'>Ayush Shukla</h2>
            <h3 className=' text-2xl py-2 md:text-3xl dark:text-white'>Developer   and Competitve Programmer</h3>
          ...
          <div className='text-7xl flex justify-center gap-16 py-3 text-gray-600 dark:text-gray-400'>
           <a href="https://www.linkedin.com/in/ayush-shukla-064416b6/"><LinkedInIcon fontSize="inherit" /></a> 
           <a href="https://github.com/ayushxshukla"><GitHubIcon fontSize="inherit"/></a> 
          </div>
        ...
        <section>
          <div>
            ...
            <p className='text-md py-2 leading-8 dark:text-gray-200 text-gray-800'>
              Since the beginning of my journey as a freelance developer, I've done remote work for <span className='text-teal-500'>agencies</span> consulted for <span className='text-teal-500'>startups</span> and collabrated with talented people to create digital products for both business and consumer use.
            </p>
            <p className='text-md py-2 leading-8 dark:text-gray-200 text-gray-800'>
